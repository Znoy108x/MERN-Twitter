        ...
        <div className="w-full  border-r-2 border-zinc-900  font-kanit flex flex-col space-y-6">
            ...
            <div className="w-full h-[230px]  flex justify-between border-b-2 border-zinc-900 px-5 pt-4">
                ...
                <div className="w-[90%] h-full flex flex-col">
                    <textarea type="text" className="bg-black h-3/5 text-xl tracking-wide p-1 outline-none text-gray-400" placeholder="What's Happening ?" style={{ resize: "none" }} name="Description" value={postData.Description } onChange={(e) => setPostData({...postData , [e.target.name] : e.target.value})}/>
                    <textarea type="text" className="bg-black h-3/5 text-xl tracking-wide p-1 outline-none text-baby_blue" placeholder="Enter tags seperated by space ! 👍 Eg : #India #WoW" style={{ resize: "none" }} name="Tags" value={postData.Tags} onChange={(e) => setPostData({...postData , [e.target.name] : e.target.value})}/>
